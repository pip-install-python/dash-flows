...
# Version claims are derived, never written — a doc states
# {{VERSION:<distribution>}} and serves whatever is actually installed.
# See lib/versions.py for why, and for the code-span/fence carve-outs.
