"""
Embeddable twin of examples/30_resize_constraints.py for the docs page.
Rendered via `.. exec::docs.advanced.ex30`.
"""
...
component = html.Div([
    ...
    html.Div([
        ...
        html.Div([
            ...
            html.Span(" — aspect ratio locked 2:1, min 200×100",           style={"fontSize": "12px", "color": "var(--mantine-color-dimmed)", "marginRight": "18px"}),
            html.Span("■ Bottom-left ResizableNode", style={"color": "#8b5cf6", "fontWeight": "600", "fontSize": "12px"}),
            html.Span(" — max 400×200, min 150×80",                         style={"fontSize": "12px", "color": "var(--mantine-color-dimmed)"}),
        ], style={"marginTop": "4px"}),
        html.Div([
            html.Span("■ Right GroupNode",           style={"color": "#10b981", "fontWeight": "600", "fontSize": "12px"}),
            html.Span(" — max 500×400, min 200×150",                         style={"fontSize": "12px", "color": "var(--mantine-color-dimmed)", "marginRight": "18px"}),
            html.Span("■ Bottom-right GroupNode",    style={"color": "#f59e0b", "fontWeight": "600", "fontSize": "12px"}),
            html.Span(" — aspect ratio locked, min 150×150",                 style={"fontSize": "12px", "color": "var(--mantine-color-dimmed)"}),
        ], style={"marginTop": "2px"}),
    ], style={
