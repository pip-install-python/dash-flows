...
class SmoothStepEdge(Component):
...
- targetY (number; required):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(SmoothStepEdge, self).__init__(**args)

setattr(SmoothStepEdge, "__init__", _explicitize_args(SmoothStepEdge.__init__))
