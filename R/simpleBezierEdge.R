...
#' @export
simpleBezierEdge <- function(id=NULL, data=NULL, label=NULL, labelStyle=NULL, markerEnd=NULL, markerStart=NULL, selected=NULL, sourcePosition=NULL, sourceX=NULL, sourceY=NULL, style=NULL, targetPosition=NULL, targetX=NULL, targetY=NULL) {
